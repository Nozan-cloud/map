<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="pictures" label="封面大图">
...
<script>
  import { validator } from '../../js_sdk/validator/quanzi-articles.js';

  const db = uniCloud.database();
  const dbCollectionName = 'quanzi-articles';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,description,province,content,article_status,last_comment_user_id,pictures,publish_date,last_modify_date").get().then((res) => {
